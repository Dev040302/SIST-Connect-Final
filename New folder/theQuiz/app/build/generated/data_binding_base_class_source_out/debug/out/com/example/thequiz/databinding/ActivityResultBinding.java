...
public final class ActivityResultBinding implements ViewBinding {
  ...
  private ActivityResultBinding(@NonNull LinearLayout rootView, @NonNull AppCompatButton btnFinish,
      @NonNull ImageView ivTrophy, @NonNull TextView tvCongratulations, @NonNull TextView tvName,
      @NonNull TextView tvResult, @NonNull TextView tvScore) {
  ...
  public static ActivityResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultBinding((LinearLayout) rootView, btnFinish, ivTrophy,
          tvCongratulations, tvName, tvResult, tvScore);
    }
